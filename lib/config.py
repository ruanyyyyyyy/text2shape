...
__C.DIR.RGB_VOXEL_PATH = '/local-scratch/yuer/datasets/text2shape/shapenet/nrrd_256_filter_div_32_solid/%s/%s.nrrd'  # TODO: Modify this
__C.DIR.LOG_PATH = './output/default'
__C.DIR.CKPT_PATH = None
__C.DIR.VAL_CKPT_PATH = None
__C.DIR.DATA_PATH = '/local-scratch/yuer/datasets/text2shape/text2shape-data/'  # TODO: Modify this

__C.DIR.SHAPENET_DATA_PATH = os.path.join(__C.DIR.DATA_PATH, 'shapenet')
__C.DIR.RAW_CAPTION_CSV = '/local-scratch/yuer/data/text2shape/shapenet/captions.tablechair.csv'  # TODO: Modify this
...
__C.DIR.PRIMITIVES_RGB_VOXEL_PATH = '/local-scratch/yuer/data/text2shape/primitives/%s/%s'  # TODO: Modify this
...
__C.DIR.TOOLKIT_PATH = '/local-scratch/yuer/projects/sstk'  # TODO: Modify this
